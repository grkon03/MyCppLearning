...
namespace MCL::NN
{
    ...
    public:
        ...
        virtual math::Rmatrix forward(const math::Rmatrix &) = 0; // data should be vertical vectors
        /**
         ...
         * @return math::Rmatrix
         */
        virtual math::Rmatrix backwardByComparing(const math::Rmatrix &compared) = 0;
